          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-warm-600">Match by app name</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-warm-600">Match by website</p>
              </div>
            </button>
          </div>
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded hover:bg-warm-100 transition-colors"
                  title="Refresh app list"
                >
                  <RefreshCw className={`h-3.5 w-3.5 text-warm-500 ${isLoadingApps ? 'animate-spin' : ''}`} />
                </button>
              </div>
              ...
              <p className="text-xs text-warm-500">Apps installed on your computer</p>
            </div>
          ) : (
